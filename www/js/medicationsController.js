...
var app = angular.module('mediapp.medications',[])



app.controller("MedicationController",['$scope','$http','$location', function($scope,$http,$location){
  var mediapp = this;
  var medication = {};
